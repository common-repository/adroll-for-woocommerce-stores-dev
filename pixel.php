...
<?php
    ...
    $current_page = $global_vars['adroll_current_page'];
...
<?php
    ...
    do_action('adroll_before_pixel', $current_page, $global_vars);
?>
    adroll_adv_id = "<?php echo get_option('adroll_adv_eid') ?>";
    adroll_pix_id = "<?php echo get_option('adroll_pixel_eid') ?>";
    adroll_version = "2.0";
...
<?php
    //this allows for some customization, like including extra tracking data etc
    do_action('adroll_after_pixel', $current_page, $global_vars);
?>
<?php else: ?>
